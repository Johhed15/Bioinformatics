...
of the your coding strand DNA. Consider also backtranseqambiq (https://www.ebi.ac.uk/
Tools/st/emboss_backtranseqambig/ and check if the resulting nucleotide sequence is compatible with the true one. Do not forget to check the codon table. Explain what happened and
