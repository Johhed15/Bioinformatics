...
library(DECIPHER) # using deciper to align sequences
library(ggplot2)
library(pheatmap)
library(stringdist)
=======
...
>>>>>>> cb5d5b074a46f086c57d71f44db7c350bd759094
...
```{r}
# align 
true_msa <- msaClustalW('lizard_seqs.fasta', type='dna')
sim_msa <-  msaClustalW('artifical_lizard_seqs.fasta', type='dna')
