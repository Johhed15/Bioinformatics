...
* Signal Transduction: Genes such as GPR37, GABBR2, and RASGRF2 are integral to G-protein coupled receptor signaling or similar pathways.

* Metabolic and Biosynthetic Functions: Enzymes like ALDH1A2 and CYP27C1 are critical for vitamin A metabolism and other biochemical pathways.
...
# Define the list of GO terms and corresponding genes
go_terms <- list(
  "Developmental Process" = c("HOXB7", "HOXA5", "HOXB6", "ALDH1A2"),
  "Signal Transduction" = c("GPR37", "GABBR2", "RASGRF2", "CCNK"),
  "Immune Response" = c("IL1RL1", "SOCS2"),
  "Metabolic Process" = c("ALDH1A2", "CYP27C1"),
  "Neurological Function" = c("GABBR2", "GPR37", "RASGRF2"),
  "Cancer Pathway" = c("HOXB7", "HOXB6", "SOCS2"),
  "G Protein-Coupled Receptor Activity" = c("GPR37", "GABBR2"),
  "Embryonic Development" = c("HOXA5", "HOXB7", "HOXB6"),
  "Vitamin A Metabolism" = c("ALDH1A2"),
  "Hormone Signaling" = c("SOCS2", "IL1RL1"),
  "Protein Binding" = c("CCNK", "SOCS2", "RASGRF2"),
  "Oxidative Stress Response" = c("CYP27C1", "ALDH1A2"),
  "Immune Regulation" = c("IL1RL1", "SOCS2"),
  "Lipid and Steroid Metabolism" = c("CYP27C1", "SOCS2")
)

# Convert the list to a data frame for easy viewing and manipulation
...
# Set node types (GO Terms vs Genes)
V(graph)$type <- ifelse(V(graph)$name %in% names(go_terms), "GO Term", "Gene")

# Set colors for nodes
V(graph)$color <- ifelse(V(graph)$type == "GO Term", "lightgreen", "skyblue")
...
plot(
  ...
  vertex.size = 25,
  edge.color = "gray",
  main = "Network of Genes and Shared GO Terms"
)
